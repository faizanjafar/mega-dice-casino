...
function App() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Our support team can be contacted on <a href='' class='text-primary'>support@megadice.com</a>",
    },
  ];
  return (
      ...
      <div class="lg:px-16 2xl:px-[20%] min-[1800px]:px-[10%] min-[2200px]:px-[25%]">
        ...
        <section className="px-4 py-10 lg:px-0" id="about">
          <article className="mb-8 text-center">
            <h2 class="font-bold lg:text-8xl md:text-5xl text-4xl text-white uppercase tracking-tighter">
              <span class="strick block">WHAT IS</span>
              MEGA DICE?
            </h2>
            <p class="text-sm md:text-lg font-normal mt-8">
              ALREADY A RAPIDLY GROWING GLOBAL CRYPTO CASINO BRAND WITH OVER 50K
              PLAYERS
              <br />
              <span class="block">
                Mega Dice is not a new casino. As one of the top brands in the
                crypto casino space our focus is growth and adding value to our
                players, like with the introduction of $DICE
              </span>
            </p>
        ...
        <section className="hidden py-10 lg:block">
          <div class="flex items-center justify-between px-5">
            <p class="text-xl font-medium leading-6 border-r-2 pr-14 py-7">
              Recommended By
            </p>
            <img
              alt="Bitoinist logo"
        ...
        <section className="px-4 my-10 lg:px-0 lg:py-10">
          <h2 class="font-bold text-white uppercase tracking-tighter mb-4 text-center lg:text-7xl md:text-5xl text-4xl">
            AIRDROP <span className="strick">FOR</span>
            CASINO <span className="strick">PLAYERS</span>
          </h2>
          <div class="m-auto mb-10 text-2xl text-center md:text-3xl lg:text-5xl">
            <span class="font-bold">$2,250,000+</span> USD airdrop
          </div>
        ...
        <section className="lg:mt-10 pb-10 lg:pt-10 px-5 lg:px-0">
          <h2 class="font-bold text-white uppercase tracking-tighter text-center lg:text-7xl md:text-5xl text-4xl">
          ...
          <div className="grid grid-cols-12 lg:gap-x-10 gap-y-8 mt-10">
            <div class="flex flex-col col-span-12 row-span-2 p-10 border lg:col-span-4 bg-darkgray border-primary rounded-2xl gap-y-4">
              ...
              <h4 class="font-bold uppercase text-primary typography_featureCardHeader__nuzkN __className_4253e1 leading-6 lg:w-4/5 lg:leading-9">
                DAILY REWARDS TO HOLDERS BASED ON CASINO PERFORMANCE
              </h4>
              <p class="text-xs md:text-base __className_4253e1 undefined">
                No other platform does it quite like Mega Dice. For holders of
                $DICE that have their tokens staked, we introduce our first of
                its kind daily rewards based on the performance of Mega Dice
                Casino. Now everyone can share in the success of one of the
                worlds fastest growing online crypto casinos. There is no better
                time than now to to enjoy the benefits that come with holding
                $DICE
              </p>
              <a
                href="#"
                class="px-4 py-3 text-sm font-bold tracking-widest text-center uppercase bg-primary"
              >
                Buy now
              </a>
            </div>
        ...
        <section className="px-4 py-10 lg:px-5 lg:mt-10" id="how-to-buy">
          ...
          <div className="grid grid-cols-12 mt-10 lg:items-center">
            <div class="relative flex justify-center col-span-12 lg:col-span-6">
              <img
                alt="how to buy"
                loading="lazy"
                width="600"
                ...
                decoding="async"
                data-nimg="1"
                class="rounded-2xl text-transparent"
              ...
              <img
                ...
                decoding="async"
                data-nimg="1"
                class="absolute opacity-80 md:top-8 top-2 text-transparent"
                src="/images/logo.svg"
              />
              <div class="absolute flex flex-col items-center justify-center w-full h-full">
                <span class="md:text-5xl text-4xl font-bold mb-3 text-primary">
                  HOW TO BUY
                </span>
                <span class="__className_4253e1 mb-3 md:text-7xl text-5xl font-bold text-primary">
                  $DICE
                </span>
                <span class="md:text-[3rem] text-3xl text-white">
                  On PreSale
                </span>
              </div>
            </div>
            <div class="col-span-12 mt-6 lg:col-span-6 lg:pl-44 lg:py-12">
              <div class="mb-8 lg:pr-24">
        ...
        <section className="px-4 py-10 lg:px-5 lg:mt-10">
          ...
          <div className="grid grid-cols-12 mt-24 gap-y-20 lg:gap-y-0">
            <div class="col-span-12 lg:col-span-6 flex items-center justify-center lg:justify-start">
              <img
            ...
            <div className="col-span-12 lg:col-span-6">
              <div className="flex flex-col p-5 bg-darkgray border border-[#707070] rounded-2xl">
                ...
                <p class="mt-2 text-sm lg:text-lg">
                ...
                <div className="mt-6">
                  <div class="flex flex-col items-stretch gap-y-2">
                    <div class="px-6 py-2 flex items-center justify-between rounded-lg bg-transparent">
                      <div class="w-4 h-4 undefined rounded-full mr-1"></div>
                      <div class="flex-1 lg:basis-2/4">Fund</div>
                      <div class="flex-1 lg:basis-1/4">% Allocation</div>
                      <div class="flex-1 lg:basis-1/4">Token</div>
                    </div>
                    <hr class="h-0 border-[#8A8A8A26]" />
                    <div class="px-6 py-2 flex items-center justify-between rounded-lg bg-opacity-40 bg-black font-light">
                      <div class="w-4 h-4 bg-[#06946C] rounded-full mr-1"></div>
                      <div class="flex-1 lg:basis-2/4">Presale</div>
                      <div class="flex-1 lg:basis-1/4">35%</div>
                      <div class="flex-1 lg:basis-1/4">147,000,000</div>
                    </div>
                    <div class="px-6 py-2 flex items-center justify-between rounded-lg bg-opacity-40 bg-black font-light">
                      <div class="w-4 h-4 bg-[#0AC18E] rounded-full mr-1"></div>
                      <div class="flex-1 lg:basis-2/4">
                        Airdrops for players
                      </div>
                      <div class="flex-1 lg:basis-1/4">15%</div>
                      <div class="flex-1 lg:basis-1/4">63,000,000</div>
                    </div>
                    <div class="px-6 py-2 flex items-center justify-between rounded-lg bg-opacity-40 bg-black font-light">
                      <div class="w-4 h-4 bg-[#0EEBAD] rounded-full mr-1"></div>
                      <div class="flex-1 lg:basis-2/4">LP</div>
                      <div class="flex-1 lg:basis-1/4">15%</div>
                      <div class="flex-1 lg:basis-1/4">63,000,000</div>
                    </div>
                    <div class="px-6 py-2 flex items-center justify-between rounded-lg bg-opacity-40 bg-black font-light">
                      <div class="w-4 h-4 bg-[#65F6CD] rounded-full mr-1"></div>
                      <div class="flex-1 lg:basis-2/4">Casino $DICE pool</div>
                      <div class="flex-1 lg:basis-1/4">15%</div>
                      <div class="flex-1 lg:basis-1/4">63,000,000</div>
                    </div>
                    <div class="px-6 py-2 flex items-center justify-between rounded-lg bg-opacity-40 bg-black font-light">
                      <div class="w-4 h-4 bg-[#B3F9E6] rounded-full mr-1"></div>
                      <div class="flex-1 lg:basis-2/4">Staking rewards</div>
                      <div class="flex-1 lg:basis-1/4">10%</div>
                      <div class="flex-1 lg:basis-1/4">42,000,000</div>
                    </div>
                    <div class="px-6 py-2 flex items-center justify-between rounded-lg bg-opacity-40 bg-black font-light">
                      <div class="w-4 h-4 bg-[#B3F9E6] rounded-full mr-1"></div>
                      <div class="flex-1 lg:basis-2/4">Marketing/KOL deals</div>
                      <div class="flex-1 lg:basis-1/4">5%</div>
                      <div class="flex-1 lg:basis-1/4">21,000,000</div>
                    </div>
                    <div class="px-6 py-2 flex items-center justify-between rounded-lg bg-opacity-40 bg-black font-light">
                      <div class="w-4 h-4 bg-[#D9FCF2] rounded-full mr-1"></div>
                      <div class="flex-1 lg:basis-2/4">Affiliates</div>
                      <div class="flex-1 lg:basis-1/4">5%</div>
                      <div class="flex-1 lg:basis-1/4">21,000,000</div>
                    </div>
                  </div>
        ...
        <section className="px-4 py-8 lg:mt-10 lg:px-16">
          <div className="grid grid-cols-12 md:gap-12">
            <div class="col-span-12 lg:col-span-6">
              <div class="bg-[#000] w-full h-full sm:max-w-[50vw] mb-16 m-auto relative aspect-square">
                <img
                  alt="card"
                  loading="lazy"
                  decoding="async"
                  data-nimg="fill"
                  class="absolute object-contain brightness-50 w-full h-full top-0 left-0 right-0 bottom-0 text-transparent"
                  sizes="100vw"
                ...
                />
                <div class="relative z-10 flex flex-col justify-between h-full px-6 py-8">
                  <div class="flex items-center">
                    <img
                      alt="logo"
                      loading="lazy"
                  ...
                  <div class="relative z-10 mt-24">
                    <h2 class="font-bold text-white uppercase !leading-snug tracking-tighter lg:text-5xl md:text-4xl text-3xl">
                      <span class="strick">Next</span>{" "}
                      <span class="text-primary">GEN</span>
                      <br />
                      Casino
                      <br />
                      <span class="strick">Experience</span>
                    </h2>
                  </div>
                  <div class="mt-12 z-10 bottom-0 uppercase font-semibold tracking-widest text-sm md:text-base lg:text-lg">
                    Whitepaper
                  </div>
                </div>
              </div>
            </div>
            <div class="flex flex-col col-span-12 lg:col-span-6 gap-y-6 lg:gap-y-4 lg:justify-center">
              <h2 class="font-bold text-white uppercase tracking-tighter lg:text-5xl md:text-4xl text-3xl pt-5">
                Whitepaper
              </h2>
              <p class="w-full lg:w-4/5 text-xs lg:text-lg whitespace-wrap font-medium leading-5 -tracking-widest">
                Want to know more about $DICE and Mega Dice Casino? Our
                whitepaper has everything you need to know and you can check it
                out by clicking below!
              </p>
              <a
                href="https://dice.gitbook.io/dice-whitepaper"
                class="py-3 text-sm font-bold tracking-widest text-center uppercase bg-primary lg:px-16 lg:self-start"
                target="_blank"
              >
                Read whitepaper
              </a>
        ...
        <section className="px-4 py-8 lg:mt-10 lg:px-16" id="roadmap">
          ...
          <p class="mt-10 text-sm lg:text-lg text-center">
            Enjoy early benefits as we embark on our roadmap to make $DICE the
            leading GameFi token on Solana, seamlessly integrated with Mega Dice
            casino.
          </p>
          <div className="mt-10">
            <div class="hidden w-3/5 mx-auto columns-3 lg:block">
              <div class="flex flex-col justify-around items-end h-screen py-[20%]">
                <div>
                  <h5 class="font-black">Presale Token Claiming</h5>
                  <p class="mt-2 text-xs lg:text-base text-lightgray __className_cbf3c0">
                    To ensure a fair launch for Mega Dice, presale buyers will
                    be able to claim their tokens from the website at the same
                    time as the DEX listing.
                  </p>
                </div>
                <div>
                  <h5 class="font-black">Early Staking Incentive</h5>
                  <p class="mt-2 text-xs lg:text-base text-lightgray __className_cbf3c0">
                    Presale buyers of Mega Dice will be able to stake their
                    tokens into the smart contract before listing day to benefit
                    from the high early rewards opportunity.
                  </p>
                </div>
              </div>
              <div>
              ...
              <div class="flex flex-col justify-around h-screen py-[0%]">
                <div>
                  <h5 class="font-black __className_4253e1">
                    Presale and Marketing
                  </h5>
                  <p class="mt-2 text-xs lg:text-base text-lightgray __className_cbf3c0">
                    Mega Dice starts on a level playing field with a fair
                    presale. The team will allocate a portion of funds raised
                    towards a professional marketing strategy.
                  </p>
                </div>
                <div>
                  <h5 class="font-black __className_4253e1">
                  ...
                  <p class="mt-2 text-xs lg:text-base text-lightgray __className_cbf3c0">
                    The Mega Dice team will add a substantial liquidity pool.
                    For this purpose, 10% of the total token supply has been set
                    aside.
                  </p>
                </div>
                <div>
                  <h5 class="font-black __className_4253e1">DEX Launch</h5>
                  <p class="mt-2 text-xs lg:text-base text-lightgray __className_cbf3c0">
                    Mega Dice will launch on DEX. This will provide the best
                    trading environment and early liquidity.
                  </p>
                </div>
              </div>
            </div>
            <div class="flex gap-x-4 lg:hidden columns-2">
              <div class="w-fit">
                <img
                  alt="roadmap"
                  loading="lazy"
              ...
              <div class="flex flex-col justify-around w-full">
                <div>
                  <h5 class="font-black">Presale and Marketing</h5>
                  <p class="mt-2 text-xs lg:text-base text-lightgray">
                    Mega Dice starts on a level playing field with a fair
                    presale. The team will allocate a portion of funds raised
                    towards a professional marketing strategy.
                  </p>
                ...
                <div>
                  <h5 class="font-black">Allocated Liquidity Provision</h5>
                  <p class="mt-2 text-xs lg:text-base text-lightgray __className_cbf3c0">
                    The Mega Dice team will add a substantial liquidity pool.
                    For this purpose, 10% of the total token supply has been set
                    aside.
                ...
                <div>
                  <h5 class="font-black">DEX Launch</h5>
                  <p class="mt-2 text-xs lg:text-base text-lightgray __className_cbf3c0">
                    Mega Dice will launch on DEX. This will provide the best
                    trading environment and early liquidity.
                  </p>
        ...
        <div className="py-16" id="faqs">
          ...
          <div>
            {faqs.map((faq, index) => (
              <div class="px-4 mt-14 lg:px-0" key={index}>
                <div class="flex justify-between">
                  <h3
                    class="font-medium text-sm lg:text-2xl hover:text-primary hover:cursor-pointer -tracking-widest"
                  ...
                  <img
                    ...
                    decoding="async"
                    data-nimg="1"
                    class="w-4 lg:w-6 hover:cursor-pointer text-transparent"
                    src={`${
                      openIndex === index
                        ? "/images/arrow-up.svg"
